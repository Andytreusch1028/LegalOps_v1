    ...
    <div>
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link
            ...
            className="flex items-center gap-3 p-4 border-2 border-gray-200 rounded-lg hover:border-indigo-500 hover:bg-indigo-50 transition group"
          >
            <div className="bg-indigo-100 group-hover:bg-indigo-200 rounded-lg p-3 transition">
          ...
          >
            <div className="bg-purple-100 group-hover:bg-purple-200 rounded-lg p-3 transition">
          ...
          >
            <div className="bg-green-100 group-hover:bg-green-200 rounded-lg p-3 transition">
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-400 text-sm mt-2">Your recent orders and updates will appear here</p>
        </div>
      </div>
    </div>
  );
